...
2. Node.js installed
3. The generation script at `scripts/excalidraw-visuals/generate-visual.cjs`
...
```bash
node scripts/excalidraw-visuals/generate-visual.cjs "<FULL_PROMPT>" "projects/excalidraw-visuals/[YYYY-MM-DD]-[slug].png" "[ASPECT_RATIO]" --input "brand-assets/excalidraw-style-reference.png"
```

You can pass additional reference images (logos, screenshots, etc.) via extra `--input` arguments:
```bash
node scripts/excalidraw-visuals/generate-visual.cjs "<FULL_PROMPT>" "projects/excalidraw-visuals/[YYYY-MM-DD]-[slug].png" "[ASPECT_RATIO]" --input "brand-assets/excalidraw-style-reference.png" "path/to/another-image.png"
```

Aspect ratios: `16:9` (default), `1:1`, `2:3`, `3:2`, `3:4`, `4:3`, `4:5`, `5:4`, `9:16`, `21:9`, `auto`
...
| Script | `scripts/excalidraw-visuals/generate-visual.cjs` |
...
- Uses Nano Banana Pro (Gemini 3 Pro Image) via kie.ai
- Supports higher resolution and 4K output vs. standard Nano Banana
